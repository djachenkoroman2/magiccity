...
class CliProgressTests(unittest.TestCase):
    def test_default_output_contains_preflight_stages_and_summary(self) -> None:
        ...
        self.assertIn("stage 1/10 resolving catalogs/worldgen context started", stdout)
        ...
        self.assertIn("stage 6/10 trees started", stdout)
        self.assertIn("stage 7/10 vehicles started", stdout)
        self.assertIn("stage 8/10 sampling done", stdout)
    ...
    def test_quiet_and_verbose_modes_adjust_output(self) -> None:
        ...
        self.assertNotIn("stage 1/10", quiet_stdout)
    ...
    def test_interactive_tty_uses_tqdm_for_sampling_progress(self) -> None:
        ...
        self.assertEqual(exit_code, 0)
        self.assertIn("stage 8/10 sampling started", stdout)
    ...
    def test_mobile_lidar_stage_reports_ray_statistics(self) -> None:
        ...
        self.assertEqual(exit_code, 0)
        self.assertIn("stage 9/11 mobile LiDAR started", stdout)
