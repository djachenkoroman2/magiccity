...
Документация описывает runtime-модели, конфиги, дороги, биомы, parcels, здания, sampling, catalogs и metadata. Координатная конвенция проекта: горизонтальная плоскость `x/y`, высота `z`.
