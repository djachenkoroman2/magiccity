...
Footprint по-прежнему задает область на земле. Roof sampling никогда не должен выходить за footprint и не должен попадать во внутренний двор `courtyard`.
...
| `align_to_long_axis` | `true` | Ориентация ridge/arch относительно длинной оси bbox. |
...
Односкатная крыша. Высота монотонно растет от одной стороны bbox к другой. Подходит для industrial и современных зданий.

### `gable`

Двускатная крыша. Высота максимальна вдоль конька и снижается к двум противоположным сторонам. Конек ориентируется по длинной оси bbox.
...
Шатровая крыша с максимумом в центре bbox и снижением к краям.
